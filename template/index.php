...
<HEAD>
	<TITLE>Our interactive caption</TITLE>
...
?>
	...
	<div class="wrapper">
		<div class="navigation">
			...
			<a href="?storypart=1">
				<h1> Our interactive TG caption</h1>
			</a>
			<h4>An interactive TG caption series created by the internet!</h4>
		</div>
			
		<div class="aboutwrapper hide">
		<h2>About</h2>
			<p> Hello readers, this is an experiment I want to conduct with you guys.</p>
			<p>This interactive TG caption will be written by you guys! I don't know if this story will be super huge or just one part only written by me.</p>
			...
			<br>
			<iframe src="https://docs.google.com/forms/d/e/1FAIpQLScW7ar-dBUOhKRiO_cvuXZNmkeT00uBepCvDF9np3Rl2ps1xw/viewform?embedded=true" width="640" height="2134" frameborder="0" marginheight="0" marginwidth="0">Loading...</iframe>		</div>
